"""Simplified DiscoGAN generator variant.

Original DiscoGAN learns bidirectional mappings between two domains. For our
synthetic augmentation we expose a lightweight generator taking only latent
noise and producing normalized RGB images.
"""
